    ...
    <div className="flex justify-center p-10 bg-green-300/35">
      <div className="w-full max-w-md p-10 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800 bg-green-200">
        ...
        <p className="text-sm text-center dark:text-gray-600">
          Dont have account?{" "}
          <Link to="/register">
            <span className="text-green-600 font-bold">Register</span> here.
          </Link>
        </p>
        ...
        <div className="my-6 space-y-4">
          <button
            ...
            type="button"
            className="flex items-center justify-center w-full p-4 space-x-4 border border-green-500 rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600"
          >
            <svg
          ...
          <button
            ...
            role="button"
            className="flex items-center justify-center w-full p-4 space-x-4 border border-green-500 rounded-md focus:ring-2 focus:ring-offset-1 dark:border-green-600 focus:dark:ring-violet-600"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
