          ...
          <div className="container flex items-center justify-between h-6 mx-auto">
            <Link to="/">
              <div className="flex flex-col justify-center items-center gap-1 -mt-12 lg:-mt-8">
                <img
                  className="h-20 lg:h-24 relative p-2"
                  src="logo2.png"
                  alt=""
                />
                <h1 className="absolute bottom-2 lg:bottom-0 font-bold lg:text-3xl p-3">
                  Medi<span className="text-red-600 ">Care</span>
                </h1>
              </div>
            </Link>
              ...
              {user && (
                <>
                  <div className="dropdown dropdown-end">
                    ...
                    <ul
                      tabIndex={0}
                      className="dropdown-content z-[1] menu p-2 shadow-lg bg-green-300/70 rounded-box w-52"
                    >
                      <div className="font-bold">
                        <h1 className="border-b border-green-600 p-2 text-lg">
                          {User?.name}
                        </h1>
                      </div>
                      ...
                      <Link to="/dashboard">
                        {" "}
                        <li className="border-green-500 border-b">
            ...
            <button className="p-4 lg:hidden">
              <div className="dropdown dropdown-end">
                ...
                <ul
                  tabIndex={0}
                  className="dropdown-content z-[1] menu p-2 shadow bg-green-300 rounded-box w-52 border-slate-300 border-b"
                >
                  {user && (
