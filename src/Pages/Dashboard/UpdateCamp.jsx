...
const UpdateCamp = () => {
  ...
  const onSubmit = (data) => {
    ...
    axiosSecure.patch(`/camps/${campData._id}`, updatedCamps).then((res) => {
            ...
            <fieldset className="grid grid-cols-4 gap-6 p-6 lg:p-16 rounded-md shadow-sm bg-green-700">
              ...
              <div className="grid grid-cols-6 gap-4 col-span-full ">
                <div className="col-span-full sm:col-span-3">
                  <label htmlFor="campName" className="text-sm">
                    Camp Name
                  </label>
                  <input
                    id="campName"
                ...
                <div className="col-span-full sm:col-span-3">
                  ...
                  <input
                    ...
                    type="text"
                    placeholder="Professional Doctor"
                ...
                <div className="col-span-full sm:col-span-3">
                  <label htmlFor="participantCount" className="text-sm">
                    Participant Count
                  </label>
                  <input
                    id="participantCount"
                ...
                <div className="col-span-full sm:col-span-3">
                  <label htmlFor="campFees" className="text-sm">
                    Camp Fees
                  </label>
                  <input
                    id="campFees"
